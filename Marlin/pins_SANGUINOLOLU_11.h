...
#define HEATER_0_PIN       13   // (extruder)
  ...
  #if !defined(FAN1_PIN) && ENABLED(LCD_I2C_PANELOLU2)
    #define FAN1_PIN         4   // Uses Transistor1 (PWM) on Panelolu2's Sanguino Adapter Board to drive the fan
  #endif
...
#if !defined(FAN1_PIN) && (MB(AZTEEG_X1) || MB(STB_11) || ENABLED(IS_MELZI))
